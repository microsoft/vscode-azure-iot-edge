...
export class Constants {
    ...
    public static imgDpManifestJsonPath = ["moduleContent", "$edgeAgent", "properties.desired", "modules", "", "settings", "image"];
    // the last item is the route name enterred by the user which cannot be determined yet and will be skipped for checking
    public static routeDpManifestJsonPath = ["moduleContent", "$edgeHub", "properties.desired", "routes", ""];
